...
const AdvanceProgramDMCreation = () => {
        ...
        <>
            ...
            <section className="relative w-full text-white overflow-hidden bg-black" style={{
                ...
                {course.video && (
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-200 bg-gradient-to-t from-black to-transparent z-20"></div>
                    <div
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12">
                        ...
                        <div className="text-left">
                            <p className="text-sm sm:text-base font-normal leading-tight text-white">
                                Digital Interfaces, Wireframes, User Flow, and Visual Design.
                            </p>
                        </div>
                        </div>
                        {/* Card 2 */}
            ...
            <section className="w-full py-20 px-4 bg-black flex justify-center">
                <div className="max-w-5xl w-full mx-auto flex flex-col md:flex-row justify-between items-center gap-8 md:gap-12">
                    ...
                    <p className="opacity-80 text-sm sm:text-base md:text-lg leading-relaxed">
                        A specialized course for building intuitive and visually appealing digital experiences. Students
                        learn how to research, design, and prototype apps and websites using modern UI/UX principles.
                    </p>
                    </div>
                    ...
                    <div className="md:w-[390px] w-full flex md:justify-end">
                        <div className="bg-[#181818] rounded-2xl px-6 py-7 shadow-xl w-full max-w-[390px] space-y-5">
                            ...
                            <div>
                                ...
                                <div className="font-medium text-sm sm:text-base text-white"> Adobe Illustrator, Photoshop, Adobe XD, Figma</div>
                            </div>
                            </div>
                            {/* Format */}
...
export default AdvanceProgramDMCreation;
