...
import VideoDesignEditing from "../assets/Videos/Motion_Graphics.mp4";
...
//   {
//     module: "Module 1",
//     title: "Advanced Design Basics (Weeks 1–4)",
//     lessons: [
//       "Composition for Motion - Students design visuals that animate smoothly. ",
//       "Storyboarding - Students sketch frames to plan timing and movement. ",
//       "Brand Visuals For Video - Students adapt brand identities into video elements. ",
//     ]
//   },
//   {
//     module: "Module 2",
//     title: "Motion Graphics Core (Weeks 5–8)",
//     lessons: [
//       "After Effects Deep Practice - Students master layers, pre-comps, parenting and animation flow.",
//       "Kinetic Typography - Students animate text with strong rhythm and clarity. ",
//       "Logo & Title Animation - Students build professional intro sequences. ",
//     ]
//   },
//   {
//     module: "Module 3",
//     title: "Editing + Motion Workflow (Weeks 9–12)",
//     lessons: [
//       "Hybrid Editing Workflow - Students combine animated assets with live footage. ",
//       "Creative Transitions - Students create seamless movement scenes. ",
//       "Narrative Video Building - Students assemble story-driven timelines. ",
//     ]
//   },
//   {
//     module: "Module 4",
//     title: "Visual Effects & Finishing (Weeks 13–16)",
//     lessons: [
//       "Rotoscoping & Masking - Students isolate subjects and blend layers. ",
//       "Tracking & Compositing - Students attach graphics to moving objects. ",
//       "Color & Atmosphere -  Students develop cinematic looks. ",
//     ]
//   },
//   {
//     module: "Module 5",
//     title: "Advanced Projects (Weeks 17–20)",
//     lessons: [
//       "Multi-Scene Animated Video - Students build a full animated explainer or promo. ",
//       "AI Workflow Support - Students explore ways to speed work, not replace creativity. ",
//       "Revision Process - Students handle feedback like professionals. ",
//     ]
//   },
//   {
//     module: "Module 6",
//     title: " Show-Reel & Industry Prep (Weeks 21–24)",
//     lessons: [
//       "Professional Show-Reel - Students compile best design, motion, and editing work. ",
//       "Freelancing & Studio Skills - Students learn rates, timelines, communication, and delivery. ",
//       "Final Presentation - Students present their portfolio and receive final critique. ",
//     ]
//   }
// ];
...
const modules = [
    {
        ...
        lessons: [
            {
                title: "Composition for Motion",
                desc: "Students design visuals that animate smoothly."
            },
            {
                title: "Storyboarding",
                desc: " Students sketch frames to plan timing and movement."
            },
            {
                title: "Brand Visuals For Video ",
                desc: " Students adapt brand identities into video elements."
            },
        ]
     },
  {
    ...
    lessons: [
        {
            title: "After Effects Deep Practice ",
            desc: "Students master layers, pre-comps, parenting and animation flow."
        },
        {
            title: "Kinetic Typography",
            desc: "Students animate text with strong rhythm and clarity."
        },
        {
            title: "Logo & Title Animation",
            desc: " Students build professional intro sequences."
        },
    ]
    },
    {
        ...
        lessons: [
                {
                    title: "Hybrid Editing Workflow",
                    desc: "Students combine animated assets with live footage."
                },
                {
                    title: "Creative Transitions",
                    desc: " Students create seamless movement scenes."
                },
                {
                    title: "Narrative Video Building - ",
                    desc: " Students assemble story-driven timelines."
                },
        ]
    },
   {
        ...
        lessons: [
                {
                    ...
                    desc: " Students isolate subjects and blend layers."
                },
                {
                    title: "Tracking & Compositing ",
                    desc: "Students attach graphics to moving objects."
                },
                {
                    title: "Color & Atmosphere ",
                    desc: "  Students develop cinematic looks."
                },
        ]
    },
    {
        ...
        lessons: [
                {
                    title: "Multi-Scene Animated Video  ",
                    desc: " Students build a full animated explainer or promo."
                },
                {
                    title: "AI Workflow Support  ",
                    desc: "Students explore ways to speed work, not replace creativity."
                },
                {
                    title: "Revision Process ",
                    desc: " Students handle feedback like professionals."
                },
        ]
    },
     {
        ...
        lessons: [
                {
                    title: "Professional Show-Reel",
                    desc: " Students compile best design, motion, and editing work."
                },
                {
                    title: "Freelancing & Studio Skills",
                    desc: "Students learn rates, timelines, communication, and delivery. "
                },
                {
                    title: "Final Presentation",
                    desc: " Students present their portfolio and receive final critique."
                },
        ]
    },
];
...
export const MotionVerse_Couse = () => {
                    ...
                    <div className="absolute left-0 right-0 top-[72%] z-20 flex flex-col items-center text-center -translate-y-1/2 px-4">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3">
                            <span className="bg-gradient-to-r from-[#F9F97F] to-[#81D246] bg-clip-text text-transparent">
                                Design & Video Editing (MotionVerse)
                            </span>
                        </h2>
                ...
                <div className="md:w-[390px] w-full flex md:justify-end">
                    <div className="bg-[#181818] rounded-2xl px-6 py-7 shadow-xl w-full max-w-[390px] space-y-5">
                        ...
                        <div>
                            ...
                            <div className="font-medium text-sm sm:text-base text-white">6 Months | 24 Weeks</div>
                        </div>
                        </div>
                        {/* Batches */}
                        <div className="flex items-center mb-6">
