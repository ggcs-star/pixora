...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent text-white  px-16 py-4 flex items-center justify-between">
      {/* Logo */}
      ...
      <div className="hidden md:flex space-x-8 text-sm font-medium">
        ...
        <Link to="/why-us" className="hover:text-gray-300 transition">
          Why Choose Us
        </Link>
      </div>
      ...
      <div>
        <Link
          to="/inquiry"
          className="bg-[#F5614C] hover:bg-[#e64a36] text-white px-6 py-2 rounded-full text-sm font-semibold transition"
        >
          Inquiry Now
        </Link>
      </div>
