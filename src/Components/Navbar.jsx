...
const Navbar = () => {
  ...
  return (
    // <nav className="fixed top-0 left-0 right-0 z-[1100] bg-transparent backdrop-blur-md text-white px-4 sm:px-6 md:px-23 py-3 sm:py-3 flex items-center justify-between 2xl:px-77 2xl:py-6">
    //   {/* Logo */}
    //   <div
    //     className="text-2xl font-extrabold tracking-widest relative z-[1110] cursor-pointer"
    //     onClick={() => navigate("/")}
    //   >
    //     <img
    //       src={logo.src}
    ...
    //   {/* Desktop Links */}
    //   <div className="hidden md:flex space-x-8 text-sm font-medium relative z-[1000]">
    ...
    // </nav>
      ...
      <nav className="fixed top-0 left-0 right-0 z-[1100] bg-transparent backdrop-blur-md text-white px-4 sm:px-6 md:px-10 md:py-4 lg:px-23 lg:py-3 2xl:px-77 2xl:py-3 flex items-center justify-between">
        {/* Logo */}
        <div
        ...
        {/* Desktop Links */}
        <div className="hidden md:flex space-x-6 md:space-x-8 text-sm md:text-sm 2xl:text-xl font-medium relative z-[1000]">
          {menuLinks.map((link, i) => (
            <Link key={i} to={link.path} className="hover:text-gray-300 transition">
              {link.name}
            </Link>
